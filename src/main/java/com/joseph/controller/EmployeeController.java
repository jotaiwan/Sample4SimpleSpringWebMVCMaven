...
public class EmployeeController {
    ...
    public String all(Model model) {
        ...
        logger.info("Info, getting all employees information");
        logger.debug("Debug, getting all employees information");
        logger.error("Error, getting all employees information");
        return "employee";
    }
